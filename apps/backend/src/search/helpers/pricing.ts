...
/**
 * The currencies the index holds prices in — the store currencies this project
 * seeds. Each gets its own set of price fields, so filtering and sorting work
 * per currency. Adding one is a schema change: the module reindexes on the next
